...
func initUserRouter(e *echo.Echo) {
	...
	g.GET("/:uid", controller.GetUserProfile, middleware.JWTWithConfig(util.Conf))
	g.PUT("/account", controller.GetUserAccount, middleware.JWTWithConfig(util.Conf), myware.VerifyUser)
	g.PUT("/account", controller.ChangeUserInfo, middleware.JWTWithConfig(util.Conf), myware.VerifyUser)
	g.PUT("/pwd", controller.ChangeUserPwd, middleware.JWTWithConfig(util.Conf), myware.VerifyUser)
